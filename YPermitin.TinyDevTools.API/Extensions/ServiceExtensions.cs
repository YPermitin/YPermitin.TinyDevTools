...
namespace YPermitin.TinyDevTools.API.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            ...
            {
                setupAction.SwaggerDoc("TinyDevToolsServiceAPISpecification", new OpenApiInfo()
                {
                    Title = "TinyDevTools service API",
                    Version = "1",
                    Description = "TinyDevTools service API - небольшой набор инструментов для разработчиков.",
                ...
                foreach (var xmlDocFile in xmlDocFiles)
                {
                    ...
                    if (xmlDocFileInfo.Name.StartsWith("YPermitin.TinyDevTools."))
                    {
            ...
            app.UseSwaggerUI(setupAction =>
            {
                ...
                setupAction.IndexStream = ()
                    => assemblyType.Assembly
                        .GetManifestResourceStream("YPermitin.TinyDevTools.API.EmbeddedAssets.API.index.html");
            ...
            services.AddControllers(setupAction =>
            {
                ...
                .ConfigureApiBehaviorOptions(setupAction =>
                {
                    setupAction.InvalidModelStateResponseFactory = context =>
                    {
                        ...
                        {
                            problemDetails.Type = "https://tinydevtools.ru/modelvalidationproblem";
